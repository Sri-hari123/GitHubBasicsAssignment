...
<body>
    ...
    <sql:query var="select" dataSource="${db}">
        select * from task where user_id = <%= userId %> order by priority desc, end_date;
    </sql:query>
...
<!-- This page was to display the task that is to be performed of that particular user who has logged in and we have a delete button which is used to delete that particular task
	We have a logout button which can be used to logout 
	The add task button redirect it to the 'AddTask.jsp'-->